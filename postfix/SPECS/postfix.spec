...
%changelog
* Mon Jul 02 2012 Jaroslav Škarvada <jskarvad@redhat.com> - 2:2.3.3-6
- Fixed FD leak in biff
  Resolves: rhbz#766499
- Removed exec mode from documentation files

* Tue Jun 26 2012 Jaroslav Škarvada <jskarvad@redhat.com> - 2:2.3.3-5
...
* Thu May 12 2011 Jaroslav Škarvada <jskarvad@redhat.com> - 2:2.3.3-4
- fix CVE-2011-1720 (#704135)
  Resolves: rhbz#704135

* Thu Mar 10 2011 Jaroslav Škarvada <jskarvad@redhat.com> - 2:2.3.3-3
- fix CVE-2011-0411 (#683389)
- fix CVE-2008-2937 (#683389)
- defuzzification of patches

* Mon Aug 11 2008 Thomas Woerner <twoerner@redhat.com> 2:2.3.3-2.2
- fixed postfix privilege problem with symlinks in the mail spool directory
  (CVE-2008-2936)
  Resolves: rhbz#456718
